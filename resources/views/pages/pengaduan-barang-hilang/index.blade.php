                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <a href="{{ route('pengaduan-barang-hilang.create') }}" class="btn btn-primary mb-2">Buat Pengaduan</a>
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ $item->foto() }}" class="img-fluid" alt="" style="max-height:40px"></td>
                                    <td>
                                        {!! $item->status() !!}
                                    </td>
                                </tr>
