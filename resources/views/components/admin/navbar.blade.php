    ...
    <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right ml-auto">
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown"
                    ...
                    <img alt="image" src="{{ asset('assets/be/img/avatar/avatar-1.png') }}" class="rounded-circle mr-1">
                    <div class="d-sm-none d-lg-inline-block">{{ Str::ucfirst(auth()->user()->name) }}</div>
                </a>
