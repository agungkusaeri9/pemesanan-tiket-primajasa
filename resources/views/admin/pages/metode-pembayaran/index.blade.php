        ...
        <div class="section-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('admin.metode-pembayaran.create') }}" class="btn btn-sm btn-primary mb-3"><i
                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->pemilik }}</td>
                                            <td>
                                                <a href="{{ route('admin.metode-pembayaran.edit', $item->id) }}"
                                                    class="btn btn-sm btn-info"><i class="fas fa-edit"></i> Edit</a>
                                                <form action="" method="post"
                                                    class="d-inline" id="formDelete">
                                                    @csrf
                                                    @method('delete')
                                                    <button data-action="{{ route('admin.metode-pembayaran.destroy',$item->id) }}" class="btn btn-sm btn-danger btnDelete"><i
